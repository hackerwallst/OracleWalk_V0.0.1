...
//|                                                                  |
//| Execution: the live-oriented default monitors every tick after   |
//| FVG detection and fires when Bid crosses the 50% midpoint.       |
//+------------------------------------------------------------------+
#property strict
#property description "FVG SMA9 Body60 TickTouch - BacktestCore conversion"
...
input ENUM_FVG_EXECUTION_MODE InpExecutionMode      = FVG_TICK_TOUCH;
...
input long                    InpMagicNumber        = 990209;
input string                  InpSignalsCsvName     = "FVG_SMA9_Body60_TickTouch_signals.csv";
input string                  InpTradesCsvName      = "FVG_SMA9_Body60_TickTouch_trades.csv";
...
void OnDeinit(const int reason)
{
   ...
   PrintFormat("FVG_SMA9_Body60_TickTouch: wrote %d signals to:", ArraySize(g_sig_time));
