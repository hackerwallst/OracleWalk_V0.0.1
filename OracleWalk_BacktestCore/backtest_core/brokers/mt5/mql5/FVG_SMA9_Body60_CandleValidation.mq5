//+------------------------------------------------------------------+
//| FVG_SMA9_Body60_CandleValidation.mq5                             |
...
//|                                                                  |
//| Execution: validation mode logs candle-close signals only.        |
//+------------------------------------------------------------------+
#property strict
#property description "FVG SMA9 Body60 CandleValidation - BacktestCore parity audit"
...
input ENUM_FVG_EXECUTION_MODE InpExecutionMode      = FVG_SIGNALS_ONLY;
...
input long                    InpMagicNumber        = 990260;
input string                  InpSignalsCsvName     = "FVG_SMA9_Body60_CandleValidation_signals.csv";
input string                  InpTradesCsvName      = "FVG_SMA9_Body60_CandleValidation_trades.csv";
...
void OnDeinit(const int reason)
{
   ...
   PrintFormat("FVG_SMA9_Body60_CandleValidation: wrote %d signals to:", ArraySize(g_sig_time));
