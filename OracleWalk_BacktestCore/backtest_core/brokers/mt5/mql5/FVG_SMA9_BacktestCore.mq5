...
//+------------------------------------------------------------------+
#property strict
#property description "BacktestCore FVG Imbalance EA, faithful signal logic, SMA9"
...
input string                  InpSignalsCsvName     = "FVG_SMA9_BacktestCore_signals.csv";
input string                  InpTradesCsvName      = "FVG_SMA9_BacktestCore_trades.csv";
...
void OnDeinit(const int reason)
{
   ...
   PrintFormat("FVG_SMA9_BacktestCore: wrote %d signals to:", ArraySize(g_sig_time));
